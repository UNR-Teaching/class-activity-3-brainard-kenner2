...
class GameTester(unittest.TestCase):
    ...
    def test_has_winner_diagonal(self):
        ...
        self.assertEqual(self.game.get_win_state(self.game.board), PLAYER_1_WIN)
    ...
    def test_has_winner_horizontal(self):
        ...
        self.assertEqual(self.game.get_win_state(self.game.board), PLAYER_2_WIN)
    ...
    def test_has_no_winner(self):
        ...
        self.assertEqual(self.game.get_win_state(self.game.board), NO_WIN)
    ...
    def test_has_no_winner_tie(self):
        ...
        self.game.board.mark_square(2, 2, 'X')
        self.assertEqual(self.game.get_win_state(self.game.board), TIED)
    ...
    def test_board_valid_correct(self):
        ...
        self.game.board.mark_square(1, 2, 'O')
        self.game.board.mark_square(2, 0, 'O')
        self.assertTrue(self.game.board_valid(self.game.board))
    ...
    def test_board_valid_too_many_X(self):
        ...
        self.assertFalse(self.game.board_valid(self.game.board))
